...
func TestD1EndpointCharacterization(t *testing.T) {
	for _, tc := range []struct{ raw, want, message string }{
		{" HTTPS://EXAMPLE.COM:443/base/v1/// ", "https://example.com/base", ""},
		{"https://[FE80::AB%25EthZ]:443/base/v1", "https://[fe80::ab%25EthZ]/base", ""},
		{"https://[FE80::AB%25EthZ]:8443/base/v1", "https://[fe80::ab%25EthZ]:8443/base", ""},
		{"https://EXAMPLE.COM/a%2Fb/v1", "https://example.com/a/b", ""},
		{"http://LOCALHOST:80/", "http://localhost", ""},
		{"http://127.12.3.4:8080/", "http://127.12.3.4:8080", ""},
		{"http://[::1]:80/", "http://[::1]", ""},
		{"https://EXAMPLE.COM/base/v1/child", "https://example.com/base/v1/child", ""},
		...
		t.Run(tc.raw, func(t *testing.T) {
			got, err := validateOpenSandboxAPIURL(tc.raw)
			if got != tc.want {
			...
			if err == nil || err.Error() != "provider=opensandbox API URL "+tc.message || core.ExitCodeForError(err, 1) != 2 {
